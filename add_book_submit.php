<?php
	...
	//echo $var1.$var2.$var3.$var4.$var5;
			...
			$query="select * from book where id = '".$var5."'";
			$run=mysql_query($query);
			
			
				mysql_query("INSERT INTO book(title,author,publication,genre,id,cost,copies) 
				VALUES('$var1','$var2','$var4','$var5','$var3','$var6','$var7')") or die (mysql_error());
	...
	<div id="site_content">		
	  ...
	  <div class="sidebar_container">       
        ...
        <div class="sidebar">
          <div class="sidebar_item">
            <h2>Contact</h2>
            <p>Phone: +91 9816928095</p>
            <p>Email: <a href="mailto:info@youremail.co.in">info@youremail.co.in</a></p>
          </div><!--close sidebar_item--> 
        </div><!--close sidebar-->
